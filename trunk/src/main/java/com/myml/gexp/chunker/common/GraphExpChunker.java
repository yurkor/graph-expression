        ...
        public static String toString(List<Node> node) {
                ...
                for (int i = 0, nodeSize = node.size(); i < nodeSize; i++) {
                        ...
                        for (Edge e : CONTEXT.getEdges(n)) {
                                ...
                                sb.append(ee.getAnn().type + "[").append(StringUtils.substring(ee.getAnn().getContent(), 0, 100)).append("] n").append(ind).append(", ");
                        }
...
//    }
        ...
        public static Transformer<GraphMatchWrapper, Double> withGroupScorer(final String groupName, final double has, final double hasNot) {
